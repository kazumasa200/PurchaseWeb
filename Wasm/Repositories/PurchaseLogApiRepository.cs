...
public class PurchaseLogApiRepository : ApiServiceBase, IPurchaseLogRepository
{
    public PurchaseLogApiRepository(HttpClient http, ITenantProvider tenantProvider)
